...
namespace PL.Areas.Identity.Pages.Account.Manage
{
    public class ChangePasswordModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            [Display(Name = "Contraseña Actual")] /*Current password*/
        ...
        public async Task<IActionResult> OnGetAsync()
        {
            ...
            if (user == null)
            {
                return NotFound($"No se puede cargar el usuario con Identificacion '{_userManager.GetUserId(User)}'."); /*Unable to load user with ID */
            }
        ...
        public async Task<IActionResult> OnPostAsync()
        {
            ...
            _logger.LogInformation("El usuario cambió su contraseña exitosamente."); /*User changed their password successfully.*/
            StatusMessage = "Tu contraseña ha sido cambiada."; /*Your password has been changed*/
